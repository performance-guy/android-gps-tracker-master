...
import com.ods.salman.Login.Helper.SQLiteHandler;
import com.ods.salman.Login.Helper.SessionManager;
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        String countru = user.getString("country");
//                        constant.context = getContext();
//                        constant.savePreferences("country",countru);
//                        constant.savePreferences("mobile",mobile);
//                        constant.savePreferences("name",name);
//                        constant.savePreferences("email",email);
                        // Inserting row in users table
                        db.addUser(name, email, mobile, countru, uid, created_at);

                        // Launch main activity
                        Intent intent = new Intent(getApplicationContext(),UbidotsActivity.class);
                        startActivity(intent);
                        finish();
                    } else {
